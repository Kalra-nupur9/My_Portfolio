...
function page() {
    return (
        <section className="w-full py-16 bg-gradient-to-r from-pink-300 via-white to-rose-300" id="Project">
      <h2 className="text-center text-4xl md:text-6xl font-bold  mb-16 text-indigo-700">MY PROJECTS</h2>
