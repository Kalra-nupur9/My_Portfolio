          ...
          <div className="flex items-center justify-between h-16 ">
            <div className="flex items-center">
              <div className="flex-shrink-0">
                <a href="" className="text-black tracking-tightest text-8xl">NK</a>
              </div>
            </div>
  ...
  <path fillRule="evenodd" d="M2.5 12a.5.5 0 0 1 .5-.5h10a.5.5 0 0 1 0 1H3a.5.5 0 0 1-.5-.5m0-4a.5.5 0 0 1 .5-.5h10a.5.5 0 0 1 0 1H3a.5.5 0 0 1-.5-.5m0-4a.5.5 0 0 1 .5-.5h10a.5.5 0 0 1 0 1H3a.5.5 0 0 1-.5-.5"/>
        ...
        {isClick && (
            <div className="md-hidden flex justify-end ">
              ...
              <a href="/home  " className=" text-xl text-black block text-center hover:text-main-red  font-medium py-2">
                  Home
                </a>
                <a href="/my-project  " className=" text-xl text-black text-center block hover:text-red-600  font-medium py-2">
                  My-Projects
                </a>
                <a href="/my-skills  " className=" text-xl text-black text-center block hover:text-red-600   font-medium py-2">
                  My Skills
                </a>
                <a href="/contact-me  " className=" text-xl text-black text-center block hover:text-red-600   font-medium py-2">
                  Contact Me
                </a>
              </div>
            </div>
